...
##########################################################################################
def timeseries_all(folder_name, keep_thresh):
	...
	# ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ # ~ #
	##########################################################################################
	sarc_data_normalized_fname = out_time + '/tracking_results_frames.txt'
	np.savetxt(sarc_data_normalized_fname, arr_frames)
	sarc_data_normalized_fname = out_time + '/tracking_results_leng.txt'
	np.savetxt(sarc_data_normalized_fname, all_normalized)
	sarc_data_fname = out_time + '/tracking_results_leng_NOT_NORMALIZED.txt'
	np.savetxt(sarc_data_fname, arr_leng)
	sarc_data_fname = out_time + '/tracking_results_wid.txt'
	np.savetxt(sarc_data_fname,ALL_wid_GPR)
	sarc_data_fname = out_time + '/tracking_results_ang.txt'
	np.savetxt(sarc_data_fname,ALL_ang_GPR)
	sarc_data_fname = out_time + '/tracking_results_x_pos.txt'
	np.savetxt(sarc_data_fname,ALL_x_pos_GPR)
	sarc_data_fname = out_time + '/tracking_results_y_pos.txt'
	np.savetxt(sarc_data_fname,ALL_y_pos_GPR)


	sarc_idx_fname = out_time + '/tracking_results_sarc_idx_above_thresh.txt'
	np.savetxt(sarc_idx_fname, np.asarray(ALL_idx_above_thresh))

	plot_info_frames_fname = out_time + '/plotting_all_frames.pkl'
	with open(plot_info_frames_fname, 'wb') as f:
		pickle.dump(ALL_frames_above_thresh,f)

	plot_info_x_pos_fname = out_time + '/plotting_all_x.pkl'
	with open(plot_info_x_pos_fname, 'wb') as f:
		pickle.dump(ALL_x_pos_above_thresh, f)

	plot_info_y_pos_fname = out_time + '/plotting_all_y.pkl'
